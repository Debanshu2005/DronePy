...
class VideoDeviceProvider:
    """Best-effort scan for Linux video devices such as USB or CSI cameras."""
...
class DeviceInventoryDetector:
    def __init__(self, providers: list[DeviceProvider] | None = None) -> None:
        self.providers = providers or [SerialPortProvider(), VideoDeviceProvider()]
